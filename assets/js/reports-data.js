    ...
    yara: [
      {
        ...
        rule: "rule StealcStealer\n{\n    meta:\n        description = \"Detect Stealc Stealer Family\"\n        author      = \"SalahEldin Kamil (Mr_MaTriX)\"\n    strings:\n        $m1 = \"C:\\\\builder_v2\\\\stealc\\\\json.h\" ascii wide\n        $m2 = \"C:\\\\builder_v3\\\\build\\\\json.h\"  ascii wide\n\n        $s1 = \"steal_foxmail\" ascii wide\n        $s2 = \"steal_winscp\" ascii wide\n\n        $rc4_32 = {\n            6A 12\n            68 ?? ?? ?? ??\n            B9 ?? ?? ?? ??\n            E8 ?? ?? ?? ??\n        }\n        $data_32 = {\n            68 ?? ?? ?? ??\n            8D 4? ??\n            E8 ?? ?? ?? ??\n            8D 5? ??\n            8D 4? ??\n            E8 ?? ?? ?? ??\n        }\n        $RC4_64 = {\n            4C 8D 3D ?? ?? ?? ??\n            49 8? ??\n            E8 ?? ?? ?? ??\n            33 ??\n        }\n        $data_64 = {\n            48 8D 0D ?? ?? ?? ??\n            [0-20]\n            E8 ?? ?? ?? ??\n            [0-20]\n            48 8D 15 ?? ?? ?? %%\n            48 !! !! !!\n            E8 !! !! !! !!\n        }\n    condition:\n        uint16(0) == 0x5A4D and\n        filesize < 5MB and\n        (($RC4_64 and $data_64) or ($rc4_32 and $data_32)) and\n        (1 of ($m*) and 1 of ($s*))\n}",
      },
    ],
  },
  {
...

  {
    ...
    yara: [
      ...
      },
      {
        ...
        author: "SalahEldin Fikri (Mr_MaTriX)",
        rule: "rule Evelyn_Stealer\n{\n    meta:\n        description = \"Detects Evelyn Stealer payload\"\n        author      = \"SalahEldin Fikri (Mr_MaTriX)\"\n    strings:\n        $m1 = \"[-] All upload attempts failed - data saved locally in Evelyn folder\" ascii wide\n        $m2 = \"[*] Copying wallets to Evelyn\\\\Wallets...\" ascii wide\n        $m3 = \"[*] Starting Evelyn Browser Extractor...\" ascii wide\n        $m4 = \"[-] ERROR: Failed to create Evelyn folder\" ascii wide\n        $m5 = \"[+] Evelyn folder: %s\" ascii wide\n        $m6 = \"[*] Copying wallets to Evelyn\\\\Wallets...\" ascii wide\n        $m7 = \"Evelyn\" ascii wide\n        $m8 = \"evelyn_status_2024\" ascii wide\n\n        $s1 = \"[*] Downloading abe_decrypt.dll from FTP server...\" ascii wide\n        $s2 = \"[-] ERROR: abe_decrypt.dll not found!\" ascii wide\n        $s3 = \"abe_decrypt.dll\" ascii wide\n        $s4 = \"/public_html/abe_decrypt.dll\" ascii wide\n        $s5 = \"  [*] Found Exodus wallet\" ascii wide\n        $s6 = \"  [*] Found Atomic wallet\" ascii wide\n        $s7 = \"[*] Stealing Telegram session...\" ascii wide\n        $s8 = \"[*] Stealing Steam session...\" ascii wide\n        $s9 = \"[*] Stealing Epic Games session...\" ascii wide\n        $s10 = \"[*] Stealing Ubisoft Connect session...\" ascii wide\n        $s11 = \"[*] Stealing FileZilla credentials...\" ascii wide\n        $s12 = \"[*] Stealing VPN configurations...\" ascii wide\n        $s13 = \"[*] Stealing clipboard data...\" ascii wide\n        $s14 = \"[*] Searching for sensitive files...\" ascii wide\n        $s15 = \"[*] Capturing running processes...\" ascii wide\n        $s16 = \"[*] Capturing screenshot...\" ascii wide\n        $s17 = \"[*] Killing existing browser processes...\" ascii wide\n        $s18 = \"[+] WiFi profiles stolen successfully\" ascii wide\n        $s19 = \"[+] Chrome injection successful\" ascii wide\n        $s20 = \"[+] Edge injection successful\" ascii wide\n        $s21 = \"[*] Found %ls wallet\\n\" ascii wide\n        $s22 = \"[*] Found other wallet extension via manifest scan\\n\" ascii wide\n        $s23 = \"[ROBLOX] Cookie: %.*s\\n\" ascii wide\n        $s24 = \"[*] Searching for sensitive files...\\n\" ascii wide\n        $s25 = \"[*] Capturing screenshot...\\n\" ascii wide\n        $s26 = \"[*] Creating system info file...\\n\" ascii wide\n        $s27 = \"[*] Crypto websites check: passwords.json not found at %ls\\n\" ascii wide\n        $s28 = \"[*] Verifying all Edge processes are terminated...\\n\" ascii wide\n        $s29 = \"[+] C2: Successfully registered client %s\\n\" ascii wide\n        $s30 = \"[+] C2: Entering polling loop...\\n\" ascii wide\n        $s31 = \"[+] Brave injection successful\\n\" ascii wide\n    condition:\n        uint16(0) == 0x5A4D and filesize < 300KB and (any of ($m*)) and (15 of ($s*))\n}"
      },
    ],
  },
